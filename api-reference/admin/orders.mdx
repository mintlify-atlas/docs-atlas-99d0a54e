...
sidebarTitle: "Orders"
description: "Admin endpoints for listing and managing orders. Enforces a strict status state machine, appends audit history, and restores stock on cancellation."
---
