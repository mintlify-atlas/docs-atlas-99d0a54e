...
description: "Admin endpoints for listing payments and confirming manual transfers. Confirmation atomically promotes the linked order from pending_payment to paid."
---
