---
title: "Customer Orders API — View Your Full Order History"
sidebarTitle: "Orders"
...
<ResponseField name="orders" type="Order[]" required>
  ...
  <Expandable title="Order object">
    ...
    <ResponseField name="orderNumber" type="string">
      Human-readable order reference in the format `AVZ-YYYYMMDD-XXXX` (e.g., `"AVZ-20241115-3742"`). Unique across all orders.
    </ResponseField>
