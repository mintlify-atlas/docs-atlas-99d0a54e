...
description: "GET /api/v1/products and GET /api/v1/products/:slug — retrieve active products with prices and images. Draft and archived products are hidden from the public."
---
