---
title: "Avanzar In Time Shop – API Session Authentication"
sidebarTitle: "Authentication"
description: "Avanzar In Time Shop uses Better Auth for cookie-based auth. Sign in once to receive a session cookie included automatically in every subsequent request."
---
